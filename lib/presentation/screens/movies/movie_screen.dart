...
import 'package:cinemapedia/presentation/providers/movies/movies_info_provider.dart';
...
class MovieScreenState extends ConsumerState<MovieScreen> {
  ...
  void initState() {
    ...
    ref.read(actorsByMovieProviderr.notifier).loadActors(widget.movieId);
  }
...
class _ActorsByMovie extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    final actorsByMovie = ref.watch(actorsByMovieProviderr);
